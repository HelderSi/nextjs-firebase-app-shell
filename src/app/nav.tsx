...
export default function Nav() {
    ...
    return <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div className="flex flex-wrap justify-between items-center">
            ...
            {/* 
            {
                authStatus === 'unauthenticated' && <Link href={'/login'}>Login</Link>
            } */}
                ...
                <div className="flex items-center lg:order-2">
                    ...
                    >
                        ...
                        <svg aria-hidden="true" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path clip-rule="evenodd" fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"></path>
                        </svg>
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        ...
                        <img
                            ...
                            src={session?.user?.image || `https://avatar.vercel.sh/0001`}
                            alt="user photo"
                        />
                    </button>
                    <div
                    ...
                    >
                        <div className="py-3 px-4">
                            ...
                            >{session?.user?.name || "Anomynous"}</span
                            >
                            <span
                                className="block text-sm text-gray-900 truncate dark:text-white"
                            >{session?.user?.email || "none@none.com"}</span
                            >
                        </div>
                        <ul
